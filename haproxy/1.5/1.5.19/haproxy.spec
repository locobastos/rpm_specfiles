...
Source0:                       https://www.haproxy.org/download/1.5/src/haproxy-%{version}.tar.gz
Source1:                       https://www.haproxy.org/download/1.5/src/haproxy-%{version}.tar.gz.sha256
...
%{__make} %{?_smp_mflags} CPU="generic" TARGET="linux2628" ARCH="x86_64" USE_OPENSSL=1 USE_PCRE=1 USE_ZLIB=1 USE_GETADDRINFO=1 ${regparm_opts} ADDINC="%{optflags}"
