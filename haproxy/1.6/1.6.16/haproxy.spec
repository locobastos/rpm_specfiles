...
Source0:                       https://www.haproxy.org/download/1.6/src/haproxy-%{version}.tar.gz
Source1:                       https://www.haproxy.org/download/1.6/src/haproxy-%{version}.tar.gz.sha256
...
%{__rm} --verbose --recursive --force %{_builddir}/%{name}-%{version}/examples/check*
